...
for(var i=1; i<10; i++){
	series = "";
	for(var j=1; j<10; j++){
		series = series + i*j + " "; // or series+=i*j + " ";
	}
	console.log(series);
}
...
for(var i=0; i<5; i++){
	...
	for(var j=1; j<=7; j++){
		...
		if(currentDay>days){  // add kora hoise
			break;
		}
...
for(var i=0; i<5; i++){
	...
	for(var j=1; j<=7; j++){
		...
		if(currentDay>9){  // add kora hoise
			dayRow += currentDay + "     "; // 1 space komanu hoise
		}else{      // add kora hose
			dayRow += currentDay + "      ";
		}
...
var monthName = "April";
var days = 30;
var startingDay = 4; // 0 from 4 add / thu
...
for(var i=0; i<5; i++){
	var dayRow = "";
	for(var j=1; j<=7; j++){
		var currentDay = 7*i + j - startingDay; // - startingDay add kor hoise
...
console.log("\n Break-7 \n");
// next
var monthName = "May, 2019"; // add may, 2019
var days = 31; // add 31
var startingDay = 2; // 0 from 2 add / tue
